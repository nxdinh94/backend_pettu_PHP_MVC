...
$routes['api/users/getDeliveryBill'] = 'user/cart/getListBillDelivery'; // API lấy danh sách hoá đơn đang vận chuyển - User
$routes['api/users/getShippedBill'] = 'user/cart/getListBillShipped'; // API lấy danh sách hoá đơn đang vận chuyển - User
